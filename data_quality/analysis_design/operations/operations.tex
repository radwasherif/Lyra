...
On the other hand we might get information from AssumptionNode state: $a = list[1] + 1$ therefore $len_{list} > 1$. From the IntervalState we get $a = TOP$. Here we want to use the information from AssumptionNode State.\\
